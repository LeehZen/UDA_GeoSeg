...
class MixedDataset(Dataset):
    def __init__(self, data_root='data/mixed_bhopal_potsdam/test', mode='val', img_dir='images_1024', mask_dir='masks_1024',
    ...
    def __getitem__(self, index):
        ...
        # print("Image right after loading Potsdam:", img)
    ...
    def get_img_ids(self, data_root, img_dir, mask_dir):
        ...
        # print(data_root, mask_dir)
        # print(len(img_filename_list), len(mask_filename_list))
        assert len(img_filename_list) == len(mask_filename_list)
        # img_ids = [str(id.split('.')[0]) for id in mask_filename_list]
        # This splits the string from the right, only once, and takes the part before the last dot.
        img_ids = [str(id.rsplit('.', 1)[0]) for id in mask_filename_list]
